                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="titleTop">
                            ...
                            <span><a href="./xuly_timkiem.php">Sản Phẩm Tìm Kiếm </a></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    if ($rs->num_rows > 0) {               
        while ($row = $rs->fetch_assoc()) {          
            ...
            $sql = "SELECT hinh_anh.ten_anh, san_pham.id, san_pham.mo_ta, san_pham.ten_san_pham, san_pham.gia_sp
                FROM hinh_anh
                JOIN san_pham ON hinh_anh.sp_id = san_pham.id WHERE loai_san_pham = '".$row["id"]."' AND ten_san_pham LIKE '%".$tukhoa."%'";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) { 
                echo '<div class="container mt-3" style="margin-bottom: 60px;">';
                echo '<div class="row">';          
